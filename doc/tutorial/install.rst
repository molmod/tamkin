...
The latest stable source code release can be downloaded here:
    ...
    http://github.com/molmod/tamkin/releases/download/v1.1.0/TAMkin-1.1.0.tar.gz

Choose a suitable directory, e.g. ``~/build``, download and unpack the archive::

    mkdir -p ~/build
    cd ~/build
    wget http://github.com/molmod/tamkin/releases/download/v1.1.0/TAMkin-1.1.0.tar.gz
    tar -xvzf TAMkin-1.1.0.tar.gz
    cd TAMkin-1.1.0
